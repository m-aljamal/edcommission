...
export default function ContactNewsletter() {
  const [activeOffice, setActiveOffice] = useState('turkey')
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#203441]">تواصل معنا</h2>
            <div className="mt-2 h-1 w-24 bg-gradient-to-r from-[#476c86] to-[#203441] mx-auto rounded-full"></div>
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              يمكنك التواصل معنا من خلال مكاتبنا في تركيا أو سوريا، أو الاشتراك في نشرتنا الإخبارية
              للبقاء على اطلاع بأحدث الأخبار والفعاليات.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
            {/* Contact Information */}
            <div className="bg-gray-100 rounded-2xl p-8 shadow-md col-span-2" dir="rtl">
              <h3 className="text-2xl font-bold text-[#203441] mb-6">مكاتبنا</h3>
              ...
              <div className="flex mb-8 bg-white rounded-lg p-1 shadow-sm">
                ...
                >
                  <span className="flex items-center justify-center gap-2">
                    <span className="text-sm font-medium">تركيا</span>
                ...
                >
                  <span className="flex items-center justify-center gap-2">
                    <span className="text-sm font-medium">سوريا</span>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h4 className="font-semibold text-[#203441] mb-1">العنوان</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#203441] mb-1">الهاتف</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#203441] mb-1">واتساب</h4>
              ...
              >
                <div className="grid grid-cols-2 gap-3 items-center">
                  <div className="space-y-3">
                    <h4 className="font-semibold text-[#203441] mb-3">مكتب دمشق:</h4>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">دمشق - كفربطنا</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    <h4 className="font-semibold text-[#203441] mb-3">مكتب حلب:</h4>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">حلب - المنشية </p>
                      </div>
                    </div>
              ...
              <div className="mt-10 pt-6 border-t border-gray-200">
                <h4 className="font-semibold text-[#203441] mb-4">تابعنا على</h4>
            ...
            <div className="bg-gradient-to-br from-[#203441] to-[#39576f] rounded-2xl p-8 text-white shadow-lg relative overflow-hidden">
              ...
              <div className="relative" dir="rtl">
                <h3 className="text-2xl font-bold mb-6">اشترك في النشرة الإخبارية</h3>
                ...
                <form className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="block mb-2 text-sm font-medium">طريقة التواصل المفضلة</label>
